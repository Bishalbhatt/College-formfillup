...
$sql="update form set name='$name',photo='$target_Path',fname='$fname',mname='$mname',nation
='$nat',caste='$caste',lea='$lea',lep='$lep' where uname='$uname'";
if($conn->query($sql)===TRUE){
  echo "<img src='$target_Path' height='200px' width='200px'><br>";
    echo "Name: ".$name."<br>";
